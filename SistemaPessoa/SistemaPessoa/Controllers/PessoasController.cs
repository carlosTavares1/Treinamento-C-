...
namespace SistemaPessoa.Controllers
{
    public class PessoasController : ApiController
    {
        ...
        [HttpGet] //Não vamos informar pelo nome mas sim pela notação em cima do método.
        [Route("Api/Pessoas/Order")]  //Definimos para a api que estamos definindo uma rota
