...
namespace WebAppSolucaoDois_04_11_19.Controllers
{
    ...
    public class ImovelsController : ControllerBase
    {
        ...
        // GET: api/Imovels
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Imovel>>> GetGetImovels()
        {
            return await _context.GetImovels.ToListAsync();
        }
        ...
        {
            var imovel = await _context.GetImovels.FindAsync(id);
        ...
        {
            _context.GetImovels.Add(imovel);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<Imovel>> DeleteImovel(int id)
        {
            ...
            _context.GetImovels.Remove(imovel);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.GetImovels.Any(e => e.Id == id);
        }
    }
}
